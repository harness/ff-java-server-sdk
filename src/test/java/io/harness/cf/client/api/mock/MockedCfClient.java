...
public class MockedCfClient extends CfClient {
  ...
  protected void doInit() throws ApiException, CfClientException {
    ...
    initFlagCache(environmentID);
    initSegmentCache(environmentID);
  ...
  @Override
  protected void initFlagCache(String environmentID) {
  ...
  @Override
  protected void initSegmentCache(String environmentID) {}
